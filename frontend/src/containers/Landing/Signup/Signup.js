...
class Signup extends Component {
    ...
    onSignupButtonClick = () => {
        var user = { email: this.state.email_input, password: this.state.pw_input, name: this.state.username_input }
                    ...
                    <div className={classes.paper}>
                        ...
                        <form className={classes.form} noValidate>
                            ...
                            <Button
                                ...
                                onClick={(event)=>{this.credentialChecker(event);this.onSignupButtonClick()}}
                            >
                                Sign Up
                          </Button>

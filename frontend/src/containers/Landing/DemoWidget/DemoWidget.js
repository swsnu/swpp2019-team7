          ...
          <Modal.Content image>
            ...
            {this.state.productInfo.productName ?
              <Modal.Description>
                ...
                <p>제조사: {this.state.productInfo.companyName}</p>
                <p>복용방법: {this.state.productInfo.takeMethod}</p>
                <p>유통기한: {this.state.productInfo.expirationDate}</p>
              </Modal.Description> :
              <Modal.Description>
